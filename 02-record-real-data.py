...
file_path = f'/home/sharath/sim2real-data-collection/data/freq{args.freq}/{args.approach}/'
...
for epi in range(431000, actions.shape[0]):
    start = time.time()
    ...
    if epi % 1000 == 0:
        np.save(file_path + 'real_world_trajectories_2.npy', real_trajectories)


np.save(file_path + 'real_world_trajectories.npy_2', real_trajectories)
